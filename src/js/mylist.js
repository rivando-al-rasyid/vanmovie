...
function createFilmCard(film) {
  ...
  article.style.cssText = 'background-color:var(--bg-card);border:1px solid var(--border-subtle)';
  article.addEventListener('mouseover', () => article.style.borderColor = 'var(--border)');
  article.addEventListener('mouseout',  () => article.style.borderColor = 'var(--border-subtle)');
  ...
  removeBtn.addEventListener('mouseover', () => { removeBtn.style.borderColor = 'var(--error)'; removeBtn.style.color = 'var(--error)'; });
  removeBtn.addEventListener('mouseout',  () => { removeBtn.style.borderColor = 'var(--border-subtle)'; removeBtn.style.color = 'var(--text-muted)'; });
